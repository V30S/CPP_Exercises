...
{
    Tiger tiger;
    Animal& tiger_as_animal = tiger; // les & sont importants car sinon il ne prevoit pas un espace pour stocker l'objet Tiger. Tiger est plus grand en memoire que Animal
